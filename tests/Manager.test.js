...
describe("Manager", () => {
    describe("managerName", () => {
        it("returns the Manager's name", () => {
            const name = "Sara";
            const newManagerName = new Manager("sarahasbeenhere@aol.com", name, "555-555-5555", "Manager");
     ...
     describe("managerEmail", () => {
        it("returns Manager's email address", () => {
            ...
            const newManagerEmail = new Manager("Sara","555-555-5555",email, "Manager");
    ...
    describe("ManagerOfficeNumber", () => {
        it("returns Manager's office number", () => {
            ...
            const managerNumber = new Manager("Sara", "sarahasbeenhere@aol.com", "Manager", officeNum);
    ...
    describe("managerRole", () => {
        it("returns Manager's role", () => {
            const role = "Manager"
            const newManagerRole = new Manager("Sara", "sarahasbeenhere@aol.com", "555-555-5555", role);
